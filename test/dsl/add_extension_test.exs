defmodule DogAPI.DSL.AddExtensionTest do
  use ExUnit.Case
  ...
  test "extensions can add other extensions" do
    defmodule Ext0 do
      ...
      use Spark.Dsl.Extension, sections: [%Spark.Dsl.Section{name: :ext0, schema: [name: [type: :atom]]}]
    end

    defmodule Ext1 do
      @moduledoc false

      use Spark.Dsl.Extension, sections: [%Spark.Dsl.Section{name: :ext1, schema: [name: [type: :atom]]}], add_extensions: [Ext0]
    end
