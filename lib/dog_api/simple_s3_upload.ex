defmodule DogAPI.SimpleS3Upload do
  @moduledoc """
  ...
  ## Examples
      ...
      {:ok, fields} =
        DogAPI.SimpleS3Upload.sign_form_upload(
          key: "/tmp/proba.jpg",
  ...
  defp access, do: Application.fetch_env!(:dog_api, :access_key_id)
  defp bucket, do: Application.fetch_env!(:dog_api, :bucket)
  defp region, do: Application.fetch_env!(:dog_api, :region)
  defp secret, do: Application.fetch_env!(:dog_api, :secret_access_key)
  ...
  defp s3_filepath(entry), do: "#{entry.uuid}.#{ext(entry)}"
