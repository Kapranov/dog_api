defmodule DogAPI.DSL.Contact do
  @moduledoc false
  ...
  defmodule Dsl do
    ...
    @contact %Spark.Dsl.Section{
      ...
      schema: [
        ...
        contacter: [
          ...
          type: {
            :spark_function_behaviour, DogAPI.DSL.Contact.Contacter,
            {DogAPI.DSL.Contact.Contacter.Function, 1}
          }
        ]
      ]
    }
    ...
    use Spark.Dsl.Extension, sections: [@contact, @personal_details, @address, @presets, @awesome_status], verifiers: [DogAPI.DSL.Contact.VerifyNotGandalf]

    def explain(dsl_state) do
      """
      * first_name: #{DogAPI.DSL.Contact.Info.first_name(dsl_state)}
      * last_name: #{DogAPI.DSL.Contact.Info.last_name(dsl_state)}
      """
    end
  end
